...
<body>
    ...
    <div class="socialinviter" type="contactimporter">
	</div> /CONTACT IMPORTER CODE -->
<div onclick="socialinviter.contactimporter.auth('gmail')">GMail</div>
<div onclick="socialinviter.contactimporter.auth('yahoo')">Yahoo</div>
<div onclick="socialinviter.contactimporter.auth('outlook')">Outlook</div>
<div onclick="socialinviter.contactimporter.auth('aol')">AOL</div>
<div onclick="socialinviter.contactimporter.auth('csv')">CSV</div>
<div onclick="socialinviter.contactimporter.auth('mailchimp')">Mailchimp</div>
<div onclick="socialinviter.contactimporter.auth('eventbrite')">Eventbrite</div>
