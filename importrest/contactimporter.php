...
<body>
            <?php
                //DECLARATION STARTS
                $license = $cilicense;
                $APIKey = '260758582221-qldcakh890jf1p7qlphemtj9uqqj3c6a.apps.googleusercontent.com';
                $APISecretKey = 'DSDCcIegvoPRYFRztEkD1nlu';
                $RedirectUrl = 'http://localhost/importrest/contactimporter.php';
                $service = 'gmail';
                $token='';
                $tokensecret = '';
                $tokenverifier = '';
